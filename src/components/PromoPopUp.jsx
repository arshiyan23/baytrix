...
function PromoPopUp() {
  ...
  const handleClose = () => {
    ...
    // Delay reset until after popup is fully hidden
    setTimeout(() => {
      setShowForm(false);
      setSubmitted(false);
    }, 400); // match CSS transition duration (popup-overlay)
  };
            ...
            <div className={`popup-slider ${showForm ? "slide-left" : ""}`}>
              ...
              <div className={`popup-panel ${submitted ? "thank-you-mode" : ""}`}>
                <div className="popup-text">
                  {submitted ? (
                    ...
                    <>
                      ...
                      <button className="popup-back" onClick={() => setShowForm(false)}>
                        ← Back
                      </button>
                    </>
                  )}
                ...
                {!submitted && (
                  <div className="popup-image">
                    <img
                      src="/assets/website-promo-2.png"
                      alt="Get Started Illustration"
                    />
                  </div>
                )}
